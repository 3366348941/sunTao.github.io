...
<script type="text/javascript">
	...
	/*	$(window).keydown(function (e) {
		...
		window.open("workbench/main/index.do","workareaFrame");//在指定的窗框：workareaFrame  代开url网页



		//鼠标单击事件， 制作安全退出
		$("#exit_confirm").click(function () {
			//思路：用户点击确定之后，发送请求：地址栏，超级链接，表单，这里采用的是地址栏
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						姓名：<b id="userName">${sessionScope.sessionUser.name}</b>  <br><br>
	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal"  id="exit_confirm" >确定</button>
				</div>
			</div>
		</div>
	</div>
